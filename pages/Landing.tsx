...
const Landing: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link to="/login" className="w-full sm:w-auto inline-flex justify-center items-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-emerald-900 bg-white hover:bg-emerald-50 md:text-lg transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Commencer maintenant
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <a href="#about" className="w-full sm:w-auto inline-flex justify-center items-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-white bg-emerald-800/80 backdrop-blur-sm hover:bg-emerald-700 md:text-lg transition-all">
                En savoir plus
              </a>
            </div>
          </div>
      ...
      <section id="about" className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-sm sm:text-base text-emerald-600 font-semibold tracking-wide uppercase">À Propos de Nous</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
            <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-shadow border border-gray-100">
              <div className="bg-emerald-100 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mb-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-shadow border border-gray-100">
              <div className="bg-blue-100 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mb-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-shadow border border-gray-100">
              <div className="bg-amber-100 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mb-6">
      ...
      {/* Services Section */}
      <section id="services" className="py-16 sm:py-24 bg-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 sm:gap-8">
            <div className="flex-1 bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-emerald-100 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4 mb-4">
                 <div className="p-3 bg-emerald-100 rounded-lg">
                    <Banknote className="h-6 w-6 sm:h-8 sm:w-8 text-emerald-600" />
                 </div>
              ...
              <ul className="space-y-3 text-sm text-gray-500">
                <li className="flex items-center bg-gray-50 p-2 rounded-lg"><span className="w-2 h-2 bg-emerald-500 rounded-full mr-3 flex-shrink-0"></span>Cycles hebdomadaires ou mensuels</li>
                <li className="flex items-center bg-gray-50 p-2 rounded-lg"><span className="w-2 h-2 bg-emerald-500 rounded-full mr-3 flex-shrink-0"></span>Tirage au sort équitable</li>
              </ul>
            </div>
            ...
            <div className="flex-1 bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-emerald-100 hover:shadow-md transition-shadow">
              ...
              <ul className="space-y-3 text-sm text-gray-500">
                <li className="flex items-center bg-gray-50 p-2 rounded-lg"><span className="w-2 h-2 bg-emerald-500 rounded-full mr-3 flex-shrink-0"></span>Retrait flexible</li>
                <li className="flex items-center bg-gray-50 p-2 rounded-lg"><span className="w-2 h-2 bg-emerald-500 rounded-full mr-3 flex-shrink-0"></span>Suivi en temps réel</li>
              </ul>
            </div>
          </div>
        </div>
